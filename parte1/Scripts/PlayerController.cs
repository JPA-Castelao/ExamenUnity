...
private void OnCollisionEnter(Collision collision)
{
 if (collision.gameObject.CompareTag("Enemy"))
    ...
    //     
    //     // Optional: Change player color to gray to show they are "dead"
 ...
 // Update the winText to display "You Lose!"
	...
	if(collision.gameObject.CompareTag("Wall")){
        Debug.Log("Mensaje para la consola");
		Vector3 direccionRebote=collision.contacts[0].normal;
        float fuerzarebote = 5.0f;
        rb.AddForce(direccionRebote * fuerzarebote, ForceMode.VelocityChange);
